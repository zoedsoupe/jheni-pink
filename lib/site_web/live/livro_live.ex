defmodule SiteWeb.LivroLive do
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "livro de visitas")}
  end
  ...
  def render(assigns) do
    ...
    <main class="bg-construction min-h-screen flex items-center justify-center p-6">
      <div class="card-y2k max-w-md text-center shadow-deep border-5">
        <span class="gif-bounce text-5xl block mb-4 font-pixel">[ i ]</span>
        <h1 class="wordart text-3xl mb-2">livro de visitas</h1>
