defmodule SiteWeb.QuartoLive do
  ...
  @apelidos ~w(jhengibrinha jhujubinha cookiezinho jhelatina frozinha morceguinho coelhinha pestinha)

  def mount(_params, _session, socket) do
    {:ok,
     socket
     |> assign(page_title: "quarto da jhujubinha ♡")
     |> assign(apelidos: @apelidos)
    ...
    <main class="bg-quarto-stripes min-h-screen px-4 py-6 pb-20">
      <div class="max-w-4xl mx-auto">
        <header class="card-y2k text-center mb-4">
          <h1 class="wordart-pink text-4xl sm:text-5xl mb-2">quarto da jhujubinha</h1>
        ...
        <div class="bg-pink text-cream py-2 border-4 border-vinho shadow-cute mb-6 marquee">
          <span class="marquee-inner font-bubblegum text-xl">
            {Enum.join(@apelidos, " ♡ ")} ♡ {Enum.join(@apelidos, " ♡ ")} ♡
          </span>
        </div>
        ...
        <div class="grid grid-1 md:grid-2 gap-4 md:items-start">
          <aside class="flex flex-col gap-4">
            ...
            <section class="bg-mostarda border-3 border-dashed border-vinho p-4 text-center">
              ...
              <span class="block text-5xl leading-none">😺</span>
            </section>
          ...
          <section class="flex flex-col gap-4">
            <article class="card-y2k">
              ...
              <div class="leading-relaxed text-base flex flex-col gap-3">
                <p>oi! sou a jhene, mas pode me chamar de jhujubinha, jhengibrinha, cookiezinho, ou qualquer apelido fofo que inventarem ♡</p>
                <p>moro em Campos onde estudo psicologia na UFF. nas férias volto pra Manhuaçu, onde minha mãe e meu Simba me esperam.</p>
                <p>cheerleader nas horas vagas — faço all-star competitivo. já competi até no Riocentro.</p>
                <p>como toda boa lésbica, tenho um stack de mulheres pra discutir: Butler, Wittig, Beauvoir, Gayle Rubin, Deleuze &amp; Guattari. <.link navigate={~p"/psico"}>vai pra estante →</.link></p>
              </div>
            </article>
            ...
            <article class="card-y2k">
              ...
              <ul class="flex flex-col gap-2">
                <li class="px-3 py-2 border-l-4 border-musgo bg-menta">zoey ♡ minha morceguinho</li>
                <li class="px-3 py-2 border-l-4 border-musgo bg-menta">Simba — gato oficial</li>
                ...
                <li class="px-3 py-2 border-l-4 border-musgo bg-menta">Djavan (zoey detesta)</li>
              </ul>
            </article>
          </section>
        </div>
